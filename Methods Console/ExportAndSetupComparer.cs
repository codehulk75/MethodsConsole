...
namespace Methods_Console
{
    class ExportAndSetupComparer
    {
        ...
        private void WriteFirstPassPnDups(StreamWriter writer)
        {
            ...
            writer.WriteLine(string.Format("{0,-25}{1,-28}{2,-20}{3,-25}", "Part Number", "Feeder", "1st Location Found", "Other Location(s)"));
            writer.WriteLine(string.Format("{0,-25}{1,-28}{2,-20}{3,-25}", "===========", "======", "==================", "================="));
            foreach (var entry in NewParser.FirstPassPnDups)
            {
                ...
                {
                    writer.WriteLine(string.Format("{0,-25}{1,-28}{2,-20}{3,-25}", entry.Key, entry.Value[i], originalLocation, entry.Value[i+2]));
                }
            }
        }
